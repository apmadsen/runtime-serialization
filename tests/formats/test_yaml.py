...
from runtime.serialization.yaml import Serializer, serialize, deserialize
...
def is_yaml(data: str):
    try:
        from yaml import load, BaseLoader
        _ = load(data, BaseLoader)
        return True
    except ValueError:
        return False
